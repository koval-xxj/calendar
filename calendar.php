...
//var_dump(date('n', strtotime('2018-03-01')));
...
// write header
$objSheet->getCell('A1')->setValue('ПН');
$objSheet->getCell('B1')->setValue('ВТ');
$objSheet->getCell('C1')->setValue('СР');
$objSheet->getCell('D1')->setValue('ЧТ');
$objSheet->getCell('E1')->setValue('ПТ');
$objSheet->getCell('F1')->setValue('СБ');
$objSheet->getCell('G1')->setValue('ВС');
...
$objSheet->getStyle('A1:D5')->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
// create medium border around the table
$objSheet->getStyle('A1:D5')->getBorders()->getOutline()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
// create a double border above total line
$objSheet->getStyle('A5:D5')->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_DOUBLE);
// create a medium border on the header line
$objSheet->getStyle('A1:D1')->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
